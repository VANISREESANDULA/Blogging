...
//   return (
//     <article
//       className={`w-full m-1 rounded-xl xs:rounded-2xl border p-3 xs:p-4 sm:p-5 md:p-6 lg:p-8 shadow-sm hover:shadow-md transition-shadow duration-300 box-border ${
...
// Helper function to get user info from comment
// Helper function to get user info from comment - UPDATED
const getUserInfoFromComment = (comment) => {
...
// Helper function to extract username/email
// Helper function to extract username/email - UPDATED
const getUsernameFromUser = (user) => {
