        ...
        <header className="sticky top-0 z-40 border-b border-border bg-background/95 backdrop-blur">
          ...
          >
            ...
            <div className="flex items-center gap-2 md:gap-4">
              ...
              <Link
                to="/profile"
                className="hidden sm:flex w-9 h-9 rounded-full bg-linear-to-br from-primary to-accent items-center justify-center text-black  bg-zinc-300 font-bold text-sm hover:shadow-lg transition-shadow"
              >
                U
              </Link>
