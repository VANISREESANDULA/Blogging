          ...
          <form onSubmit={formik.handleSubmit}>
            <div className="relative mb-6">
              <input
                ...
                id="username"
                name="username"
                className={`w-full px-4 py-3 border ${formik.errors.username ? "border-red-500" : "border-black-300"} rounded-lg bg-gray-100/10 focus:outline-none focus:border-purple-500 focus:ring-1 focus:ring-purple-500`}
            ...
            <div className="relative mb-6">
              ...
              <input
                ...
                name="email"
                required
                className={`w-full px-4 py-3 border ${formik.errors.email ? "border-red-500" : "border-black-300"} rounded-lg bg-gray-100/10 focus:outline-none focus:border-purple-500 focus:ring-1 focus:ring-purple-500`}
                onChange={formik.handleChange}
                onBlur={formik.handleBlur}
            ...
            <div className="relative mb-6">
              <input
                ...
                id="password"
                name="password"
                className={`w-full px-4 py-3 border ${formik.errors.password ? "border-red-500" : passwordStrength === "strong" ? "border-green-500" : "border-gray-800"} rounded-lg bg-gray-100/10 focus:outline-none focus:border-purple-500 focus:ring-1 focus:ring-purple-500`}
                onChange={(e) => {
            ...
            <div className="relative mb-6">
              <input
                ...
                className={`w-full px-4 py-3 border ${formik.errors.confirmpassword ? "border-red-500" : "border-gray-800"} rounded-lg bg-gray-100/10 focus:outline-none focus:border-purple-500 focus:ring-1 focus:ring-purple-500`}
                onChange={formik.handleChange}
                onBlur={formik.handleBlur}
