...
export default function Notifications() {
  ...
  const FollowRequestItem = ({ notif }) => {
    ...
    return (
      <div
        className={`p-4 rounded-lg mb-3 transition-all duration-300 hover:shadow-md ${
          isDark
          ...
          >
            ...
            >
              ...
              <div className="relative mb-6">
                ...
                />
                <input
                  className={`w-full pl-12 pr-4 py-3 rounded-lg transition-all duration-300 focus:ring-2 focus:ring-blue-500 focus:border-transparent ${
                    isDark
              ...
              <div className="flex overflow-x-auto pb-2 -mx-1">
                {tabs.map((tab) => (
                  <button
                    ...
                    className={`flex-shrink-0 px-4 py-2.5 mx-1 rounded-lg flex items-center gap-2 transition-all duration-300 whitespace-nowrap ${
