      ...
      <div className={`w-full min-h-screen transition-colors duration-300 flex justify-center p-6 ${isDark ? 'bg-gray-900' : 'bg-gray-100'} relative ${showLogoutDialog ? 'overflow-hidden' : ''}`}>
        ...
        <div className={`w-full max-w-4xl p-6 rounded-2xl shadow-md transition-colors duration-300 ${isDark ? 'bg-gray-800 border border-gray-700' : 'bg-white'}`}>
          ...
          <div className="mb-6">
            ...
            />
            {searchQuery && (
              <div className={`text-sm mt-2 px-2 transition-colors duration-300 ${isDark ? 'text-gray-400' : 'text-gray-500'}`}>
          ...
          {groupedSettings["Appearance"] && (
            <>
              <h2 className={`text-sm mb-2 transition-colors duration-300 ${isDark ? 'text-gray-400' : 'text-gray-500'}`}>Appearance</h2>
              <div className={`rounded-xl p-6 space-y-5 transition-colors duration-300 ${isDark ? 'bg-gray-800' : 'bg-gray-100'}`}>
                {groupedSettings["Appearance"].map((setting) => (
                  <div key={setting.id}>
                    ...
                    {open[setting.id] && setting.id === "appearance" && (
                      <div className="ml-10 space-y-6 animate-fadeIn">
                        {/* Theme Selection */}
                        <div className="space-y-3">
                          <h3 className={`font-medium transition-colors duration-300 ${isDark ? 'text-gray-300' : 'text-gray-700'}`}>Theme</h3>
                        ...
                        <div className="space-y-4">
                          <h3 className={`font-medium transition-colors duration-300 ${isDark ? 'text-gray-300' : 'text-gray-700'}`}>Font Family</h3>
                          <div className={`rounded-lg border p-4 transition-colors duration-300 ${isDark ? 'bg-gray-800 border-gray-700' : 'bg-gray-50 border-gray-200'}`}>
                        ...
                        {/* Font Size */}
                        <div className="space-y-4">
                          <h3 className={`font-medium transition-colors duration-300 ${isDark ? 'text-gray-300' : 'text-gray-700'}`}>Font Size</h3>
                          <div className="space-y-3">
                            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-3">
                              {fontSizeOptions.map((size) => (
                                ...
                                >
                                  ...
                                  <p className={`text-2xl transition-colors duration-300 ${isDark ? 'text-gray-200' : 'text-gray-900'}`} style={{ fontSize: `${size.value * 1.5}rem` }}>
                                    Aa
                                  </p>
                                </button>
                              ))}
                            ...
                            <p className={`text-xs transition-colors duration-300 ${isDark ? 'text-gray-400' : 'text-gray-600'}`}>
                              Current: {fontSizeOptions.find(s => s.id === currentFontSize)?.label}
                            </p>
                          </div>
                        </div>
                      </div>
          ...
          {groupedSettings["Your Account Details"] && (
            <>
              <h2 className={`text-sm mt-6 mb-2 transition-colors duration-300 ${isDark ? 'text-gray-400' : 'text-gray-500'}`}>Your Account Details</h2>
              <div className={`rounded-xl p-6 space-y-5 transition-colors duration-300 ${isDark ? 'bg-gray-800' : 'bg-gray-100'}`}>
                {groupedSettings["Your Account Details"].map((setting) => (
                  <div key={setting.id}>
                    ...
                    {open[setting.id] && setting.id === "passwords" && (
                      <div className="ml-10 mt-4 space-y-4 animate-fadeIn">
                        <div className={`space-y-4 transition-colors duration-300 ${isDark ? 'text-gray-300' : 'text-gray-700'}`}>
                          {/* Password Settings */}
                          <div className="space-y-3">
                            <h3 className={`font-semibold text-base transition-colors duration-300 ${isDark ? 'text-gray-200' : 'text-gray-900'}`}>Password Management</h3>
                            
                            <div className={`p-4 rounded-lg space-y-3 transition-colors duration-300 ${isDark ? 'bg-gray-700/50' : 'bg-white'}`}>
                          ...
                          {/* Personal Details */}
                          <div className="space-y-3 pt-2 border-t" style={{borderColor: isDark ? '#4B5563' : '#E5E7EB'}}>
                            <h3 className={`font-semibold text-base transition-colors duration-300 ${isDark ? 'text-gray-200' : 'text-gray-900'}`}>Personal Details</h3>
                          ...
                          {/* Linked Accounts */}
                          <div className="space-y-3 pt-2 border-t" style={{borderColor: isDark ? '#4B5563' : '#E5E7EB'}}>
                            <h3 className={`font-semibold text-base transition-colors duration-300 ${isDark ? 'text-gray-200' : 'text-gray-900'}`}>Linked Accounts</h3>
                            
                            <div className={`space-y-2 transition-colors duration-300`}>
                              <div className={`p-3 rounded-lg flex items-center justify-between transition-colors duration-300 ${isDark ? 'bg-gray-700/50' : 'bg-white'}`}>
                                <div className="flex items-center gap-2">
                                  <span className="text-xl">📱</span>
                                  <div>
                                    <p className={`font-medium transition-colors duration-300 ${isDark ? 'text-gray-200' : 'text-gray-900'}`}>Google Account</p>
                                    <p className={`text-xs transition-colors duration-300 ${isDark ? 'text-gray-400' : 'text-gray-600'}`}>Connected</p>
                                  </div>
                                </div>
                                <button className={`text-xs px-3 py-1 rounded transition-all duration-200 ${
                                  isDark 
                              ...
                              <div className={`p-3 rounded-lg flex items-center justify-between transition-colors duration-300 ${isDark ? 'bg-gray-700/50' : 'bg-white'}`}>
                                <div className="flex items-center gap-2">
                                  <span className="text-xl">📘</span>
                                  <div>
                                    <p className={`font-medium transition-colors duration-300 ${isDark ? 'text-gray-200' : 'text-gray-900'}`}>Facebook Account</p>
                                    <p className={`text-xs transition-colors duration-300 ${isDark ? 'text-gray-400' : 'text-gray-600'}`}>Not Connected</p>
                                  </div>
                                </div>
                                <button className={`text-xs px-3 py-1 rounded transition-all duration-200 ${
                                  isDark 
                          ...
                          <div className="space-y-3 pt-2 border-t" style={{borderColor: isDark ? '#4B5563' : '#E5E7EB'}}>
                            <h3 className={`font-semibold text-base transition-colors duration-300 ${isDark ? 'text-gray-200' : 'text-gray-900'}`}>Two-Factor Authentication</h3>
                            
                            <div className={`p-4 rounded-lg flex items-center justify-between transition-colors duration-300 ${isDark ? 'bg-gray-700/50' : 'bg-white'}`}>
                              <div>
                                <p className={`font-medium transition-colors duration-300 ${isDark ? 'text-gray-200' : 'text-gray-900'}`}>Enable 2FA</p>
                                <p className={`text-xs transition-colors duration-300 ${isDark ? 'text-gray-400' : 'text-gray-600'}`}>Add an extra layer of security to your account</p>
                              </div>
                              <ToggleSwitch 
                                isOn={false}
                          ...
                          {/* Sessions */}
                          <div className="space-y-3 pt-2 border-t" style={{borderColor: isDark ? '#4B5563' : '#E5E7EB'}}>
                            <h3 className={`font-semibold text-base transition-colors duration-300 ${isDark ? 'text-gray-200' : 'text-gray-900'}`}>Active Sessions</h3>
                            ...
                            <div className={`space-y-2 transition-colors duration-300`}>
                              <div className={`p-3 rounded-lg flex items-center justify-between transition-colors duration-300 ${isDark ? 'bg-gray-700/50' : 'bg-white'}`}>
                                <div className="flex items-center gap-2">
                                  <span className="text-xl">💻</span>
                                  <div>
                                    <p className={`font-medium transition-colors duration-300 ${isDark ? 'text-gray-200' : 'text-gray-900'}`}>Chrome on Windows</p>
                                    <p className={`text-xs transition-colors duration-300 ${isDark ? 'text-gray-400' : 'text-gray-600'}`}>Current session · Last active 2 min ago</p>
                                  </div>
                                </div>
                              </div>
                              ...
                              <div className={`p-3 rounded-lg flex items-center justify-between transition-colors duration-300 ${isDark ? 'bg-gray-700/50' : 'bg-white'}`}>
                                <div className="flex items-center gap-2">
                                  <span className="text-xl">📱</span>
                                  <div>
                                    <p className={`font-medium transition-colors duration-300 ${isDark ? 'text-gray-200' : 'text-gray-900'}`}>Safari on iPhone</p>
                                    <p className={`text-xs transition-colors duration-300 ${isDark ? 'text-gray-400' : 'text-gray-600'}`}>Last active 5 hours ago</p>
                                  </div>
                                </div>
                                <button className={`text-xs px-3 py-1 rounded transition-all duration-200 ${
                                  isDark 
                            ...
                            <button className={`w-full px-4 py-2 rounded-lg font-medium transition-all duration-200 text-red-500 border border-red-500 hover:bg-red-500/10`}>
                    ...
                    {open[setting.id] && setting.id === "privacy" && (
                      <div className="ml-10 space-y-6 animate-fadeIn">
                        <h2 className={`text-xl font-bold transition-colors duration-300 ${isDark ? 'text-gray-200' : 'text-gray-800'}`}>Account privacy</h2>
                        
                        <div className="space-y-4">
                          <div className="flex items-center justify-between">
                            <h3 className={`text-lg font-medium transition-colors duration-300 ${isDark ? 'text-gray-300' : 'text-gray-700'}`}>Private account</h3>
                            <ToggleSwitch 
                          ...
                          <div className={`space-y-3 text-sm transition-colors duration-300 ${isDark ? 'text-gray-400' : 'text-gray-600'}`}>
                            <p>
          ...
          {groupedSettings["More Information and Support"] && (
            <>
              <h2 className={`text-sm mt-6 mb-2 transition-colors duration-300 ${isDark ? 'text-gray-400' : 'text-gray-500'}`}>More Information and Support</h2>
              <div className={`rounded-xl p-6 space-y-5 transition-colors duration-300 ${isDark ? 'bg-gray-800' : 'bg-gray-100'}`}>
                    ...
                    {open[setting.id] && setting.id === "help" && (
                      <div className="ml-10 mt-4 space-y-4 animate-fadeIn">
                        <div className={`space-y-4 transition-colors duration-300 ${isDark ? 'text-gray-300' : 'text-gray-700'}`}>
                          {/* FAQ Section */}
                          <div className="space-y-3">
                            <h3 className={`font-semibold text-base transition-colors duration-300 ${isDark ? 'text-gray-200' : 'text-gray-900'}`}>Frequently Asked Questions</h3>
                            
                            <div className={`p-3 rounded-lg transition-colors duration-300 ${isDark ? 'bg-gray-700/50' : 'bg-white'}`}>
                              <p className={`font-medium mb-2 transition-colors duration-300 ${isDark ? 'text-gray-100' : 'text-gray-800'}`}>How do I create a post?</p>
                              <p className={`text-sm transition-colors duration-300 ${isDark ? 'text-gray-400' : 'text-gray-600'}`}>
                            ...
                            <div className={`p-3 rounded-lg transition-colors duration-300 ${isDark ? 'bg-gray-700/50' : 'bg-white'}`}>
                              <p className={`font-medium mb-2 transition-colors duration-300 ${isDark ? 'text-gray-100' : 'text-gray-800'}`}>How do I change my theme?</p>
                              <p className={`text-sm transition-colors duration-300 ${isDark ? 'text-gray-400' : 'text-gray-600'}`}>
                            ...
                            <div className={`p-3 rounded-lg transition-colors duration-300 ${isDark ? 'bg-gray-700/50' : 'bg-white'}`}>
                              <p className={`font-medium mb-2 transition-colors duration-300 ${isDark ? 'text-gray-100' : 'text-gray-800'}`}>Can I customize fonts?</p>
                              <p className={`text-sm transition-colors duration-300 ${isDark ? 'text-gray-400' : 'text-gray-600'}`}>
                            ...
                            <div className={`p-3 rounded-lg transition-colors duration-300 ${isDark ? 'bg-gray-700/50' : 'bg-white'}`}>
                              <p className={`font-medium mb-2 transition-colors duration-300 ${isDark ? 'text-gray-100' : 'text-gray-800'}`}>How do I bookmark posts?</p>
                              <p className={`text-sm transition-colors duration-300 ${isDark ? 'text-gray-400' : 'text-gray-600'}`}>
                            ...
                            <div className={`p-3 rounded-lg transition-colors duration-300 ${isDark ? 'bg-gray-700/50' : 'bg-white'}`}>
                              <p className={`font-medium mb-2 transition-colors duration-300 ${isDark ? 'text-gray-100' : 'text-gray-800'}`}>How do I manage my privacy?</p>
                              <p className={`text-sm transition-colors duration-300 ${isDark ? 'text-gray-400' : 'text-gray-600'}`}>
                          ...
                          {/* Support Resources */}
                          <div className="space-y-3 pt-2 border-t" style={{borderColor: isDark ? '#4B5563' : '#E5E7EB'}}>
                            <h3 className={`font-semibold text-base transition-colors duration-300 ${isDark ? 'text-gray-200' : 'text-gray-900'}`}>Need More Help?</h3>
                          ...
                          {/* Tips & Tricks */}
                          <div className="space-y-3 pt-2 border-t" style={{borderColor: isDark ? '#4B5563' : '#E5E7EB'}}>
                            <h3 className={`font-semibold text-base transition-colors duration-300 ${isDark ? 'text-gray-200' : 'text-gray-900'}`}>Quick Tips</h3>
                            
                            <ul className={`text-sm space-y-2 transition-colors duration-300 ${isDark ? 'text-gray-400' : 'text-gray-600'}`}>
                              <li>💡 Use hashtags to make your posts discoverable</li>
                              <li>💡 Reply to comments to engage with your community</li>
                              <li>💡 Check Notifications regularly to stay updated</li>
                              <li>💡 Explore trending posts to discover new creators</li>
                              <li>💡 Message friends using the Messages section</li>
                            </ul>
                          </div>
                        </div>
                      </div>
                    ...
                    {open[setting.id] && setting.id === "about" && (
                      <div className="ml-10 mt-4 space-y-4 animate-fadeIn">
                        <div className={`space-y-4 transition-colors duration-300 ${isDark ? 'text-gray-300' : 'text-gray-700'}`}>
                          {/* App Information */}
                          <div className="space-y-3">
                            <h3 className={`font-semibold text-base transition-colors duration-300 ${isDark ? 'text-gray-200' : 'text-gray-900'}`}>About Blogging App</h3>
                          ...
                          {/* Version Info */}
                          <div className={`p-4 rounded-lg transition-colors duration-300 ${isDark ? 'bg-gray-700/50' : 'bg-white'}`}>
                            <div className="space-y-2">
                              <div className="flex justify-between">
                                <span className={`font-medium transition-colors duration-300 ${isDark ? 'text-gray-100' : 'text-gray-800'}`}>App Version</span>
                                <span className={`transition-colors duration-300 ${isDark ? 'text-gray-400' : 'text-gray-600'}`}>1.0.0</span>
                              </div>
                              <div className="flex justify-between">
                                <span className={`font-medium transition-colors duration-300 ${isDark ? 'text-gray-100' : 'text-gray-800'}`}>Build</span>
                                <span className={`transition-colors duration-300 ${isDark ? 'text-gray-400' : 'text-gray-600'}`}>2025.11.29</span>
                              </div>
                              <div className="flex justify-between">
                                <span className={`font-medium transition-colors duration-300 ${isDark ? 'text-gray-100' : 'text-gray-800'}`}>Status</span>
                          ...
                          {/* Features */}
                          <div className="space-y-3 pt-2 border-t" style={{borderColor: isDark ? '#4B5563' : '#E5E7EB'}}>
                            <h3 className={`font-semibold text-base transition-colors duration-300 ${isDark ? 'text-gray-200' : 'text-gray-900'}`}>Key Features</h3>
                            
                            <ul className={`text-sm space-y-2 transition-colors duration-300 ${isDark ? 'text-gray-400' : 'text-gray-600'}`}>
                              <li>✨ Create and share unlimited posts</li>
                              <li>✨ Customize your profile and appearance</li>
                              <li>✨ Engage with community through likes and comments</li>
                              <li>✨ Bookmark your favorite posts</li>
                              <li>✨ Private messaging with friends</li>
                              <li>✨ Explore trending content and creators</li>
                              <li>✨ Personalized notifications</li>
                              <li>✨ 15+ Font options and 5 size adjustments</li>
                          ...
                          {/* Technology Stack */}
                          <div className="space-y-3 pt-2 border-t" style={{borderColor: isDark ? '#4B5563' : '#E5E7EB'}}>
                            <h3 className={`font-semibold text-base transition-colors duration-300 ${isDark ? 'text-gray-200' : 'text-gray-900'}`}>Built With</h3>
                          ...
                          {/* Legal & Links */}
                          <div className="space-y-3 pt-2 border-t" style={{borderColor: isDark ? '#4B5563' : '#E5E7EB'}}>
                            <h3 className={`font-semibold text-base transition-colors duration-300 ${isDark ? 'text-gray-200' : 'text-gray-900'}`}>Legal & Resources</h3>
                            
                            <div className="space-y-2">
                              <p className={`text-sm cursor-pointer hover:text-blue-500 transition-colors duration-300 ${isDark ? 'text-gray-400' : 'text-gray-600'}`}>
                          ...
                          {/* Credits */}
                          <div className="space-y-3 pt-2 border-t" style={{borderColor: isDark ? '#4B5563' : '#E5E7EB'}}>
                            <h3 className={`font-semibold text-base transition-colors duration-300 ${isDark ? 'text-gray-200' : 'text-gray-900'}`}>Credits</h3>
          ...
          <h2 className={`text-sm mt-6 mb-2 transition-colors duration-300 ${isDark ? 'text-gray-400' : 'text-gray-500'}`}>Login Details</h2>
          <div className={`rounded-xl p-6 space-y-4 transition-colors duration-300 ${isDark ? 'bg-gray-800' : 'bg-gray-100'}`}>
            {/* Current Account */}
            <div>
              <p className={`text-xs font-semibold mb-2 transition-colors duration-300 ${isDark ? 'text-gray-400' : 'text-gray-500'}`}>CURRENT ACCOUNT</p>
              <div className={`p-3 rounded-lg flex items-center justify-between transition-colors duration-300 ${isDark ? 'bg-gray-700' : 'bg-white'}`}>
                <div className="flex items-center gap-3">
            ...
            <div>
              ...
              {showAddAccountOptions && (
                <div className={`ml-4 space-y-3 animate-fadeIn border-l-2 pl-4 py-2 transition-colors duration-300 ${isDark ? 'border-gray-600' : 'border-gray-300'}`}>
                  <p 
...
function AccordionItem({ title, icon, open, onClick, isDark }) {
  return (
    <div className={`flex justify-between items-center cursor-pointer transition-colors duration-300 ${isDark ? 'text-gray-300' : 'text-gray-700'}`} onClick={onClick}>
      <div className="flex items-center gap-3">
...
function ThemeOption({ title, icon, description, isSelected, onClick, isDark }) {
  return (
    ...
    >
      ...
      <h4 className={`font-medium transition-colors duration-300 ${isDark ? 'text-gray-200' : 'text-gray-800'}`}>{title}</h4>
      <p className={`text-sm mt-1 transition-colors duration-300 ${isDark ? 'text-gray-400' : 'text-gray-500'}`}>{description}</p>
    </div>
  );
}
